...
m=models.Sequential([layers.Conv2D(32,3,activation='relu',input_shape=(28,28,1)),
layers.MaxPooling2D(),layers.Flatten(),layers.Dense(10,activation='softmax')])
m.compile('adam','categorical_crossentropy',['accuracy'])
m.fit(xtr,ytr,epochs=3,validation_data=(xte,yte))
